  ...
  return (
    <View className="absolute bottom-4 left-0 right-0 items-center px-8">
      <BlurView
        intensity={80}
        tint="light"
        className="w-full max-w-md flex-row items-center justify-around overflow-hidden rounded-full bg-surface/80 px-6 py-3 shadow-lg">
        <Pressable
          onPress={() => navigation.navigate('index')}
          className={`rounded-full p-3 ${state.index === 0 ? 'bg-primary' : ''}`}>
          <Sparkles
            size={24}
            color={state.index === 0 ? '#ffffff' : '#874c37'}
        ...
        <Pressable
          ...
          <Palette
            size={24}
            color={state.index === 1 ? '#ffffff' : '#874c37'}
        ...
        <Pressable
          ...
          <Award
            size={24}
            color={state.index === 2 ? '#ffffff' : '#874c37'}
        ...
        <Pressable
          ...
          <Settings
            size={24}
            color={state.index === 3 ? '#ffffff' : '#874c37'}
